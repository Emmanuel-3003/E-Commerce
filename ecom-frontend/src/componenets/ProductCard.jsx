    ...
    return (
        <div className = "border rounded-lg shadow-xl overflow-hidden transition-shadow duration-300">
            ...
            <div onClick={() => {
                handleProductView({
                    id : productId,
                    productName, image, description, quantity, price, discount, specialPrice,
                })
                    ...
                    <button
                        ...
                        className = {`bg-blue-500  ${
                            isAvailable 
                                ...
                                : "opacity-70 "}
                                text-white px-2 py-3 rounded-lg items-center transition-colors duration-300 flex justify-center`}>
